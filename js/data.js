...
const npcData = [
    ...
    { name: "기와문양판", materials: "깨진기와2 + 강철1 + 적동괴1 + 송진덩어리1 + 돌덩어리2", img: "item6.png"}, { name: "접학제", materials: "송진칠료1 + 강철2 + 돌덩어리3 + 갈옥1 + 향목가루1", img: "item7.png"}, { name: "청동각인판", materials: "와편분말1 + 오금철1 + 청동파편2 + 매화옥1 + 청연광2 ", img: "item8.png"}, { name: "강화목", materials: "목심재1 + 백련강1 + 신선옥2 + 마모된인장2 + 돌덩어리2", img: "item9.png"},  { name: "기문부적", materials: "목판1 + 백련정강1 + 청강석2 + 잔존영석3", img: "item10.png"},
